...
Open today directly, or use the date picker. Previous and next day use the most recently opened journal date. Configure the folder and template in plugin settings.
